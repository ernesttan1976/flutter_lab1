...
class _FlutterLayoutArticleState extends State<FlutterLayoutArticle> {
  late int count;
  late bool showResult; // Added for toggling
  late Widget example;
  late String code;
  ...
  void initState() {
    count = 1;
    showResult = false; // Initialize to hide results
    code = Example1().code;
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        setState(() {
                          showResult = !showResult; // Toggle visibility
                        });
                      },
                      child: Text(showResult ? 'Hide Result' : 'Show Result'),
                    ),
                  ),
                  Container(
                      height: 273,
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                SizedBox(height: 15),
                                Text(
                                  showResult ? explanation : "Show Explanation",
                                  style: TextStyle(
